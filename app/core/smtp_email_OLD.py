...
def templateVerifyAccount():
    template = """"
    You received this email so that we may confirm your email address and finis=
h your login to: https://profile.materialsproject.org
    """
